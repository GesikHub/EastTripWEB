...
class OpenIDConnectBase(object):
    ...
    def validate_authorization_request(self, request):
        ...
        """
        # If request.prompt is 'none' then no auth/authorization form should
        # be presented to the user. Instead, a silent auth/authorization
        # should be performed.
    ...
    def openid_authorization_validator(self, request):
        ...
        display
                ...
                user interface pages to the End-User. The defined values are:
                    ...
                    appropriate size for a auth-focused dialog and should not
        ...
        prompt
                ...
                values are:
                    ...
                    auth - The Authorization Server SHOULD prompt the End-User
        ...
        login_hint
                OPTIONAL. Hint to the Authorization Server about the auth
