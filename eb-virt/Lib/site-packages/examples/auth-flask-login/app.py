...
# Define auth and registration forms (for flask-auth)
...
# Create customized index view class that handles auth & registration
...
def build_sample_db():
    ...
    # test_user = User(auth="test", password="test")
