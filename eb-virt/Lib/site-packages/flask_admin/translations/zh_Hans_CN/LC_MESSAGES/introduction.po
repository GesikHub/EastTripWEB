...
"/flask-admin/Flask-Admin/tree/master/examples/auth-flask-auth."
msgstr ""
...
" auth, registration, and account management views yourself."
...
"like user registration, auth, email address confirmation, password "
"resets, etc."
msgstr ""
...
msgid ""
"The example only uses the built-in `register` and `auth` views, but you "
"could follow the same approach for including the other views, like "
"`forgot_password`, `send_confirmation`, etc."
msgstr ""
"该示例仅使用内置的 `register` 和 `auth` 视图，但您可以按照相同的方法来包括其他视图，如 `forgot_password`,"
" `send_confirmation` 等。"
...
#: ../../doc/introduction.rst:422
msgid "Section to the right of the menu (can be used to add auth/logout buttons)"
